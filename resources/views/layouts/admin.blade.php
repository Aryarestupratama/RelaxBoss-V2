...
<body class="h-full font-sans antialiased">
    {{-- [PERBAIKAN #1] Ganti min-h-screen menjadi h-screen dan tambahkan overflow-hidden
         Ini memaksa layout untuk mengambil tinggi penuh layar dan tidak lebih. --}}
    <div x-data="{ sidebarOpen: false }" class="relative h-screen flex overflow-hidden bg-slate-100">

        <!-- Sidebar -->
        <x-sidebar.admin />

        {{-- [PERBAIKAN #2] Jadikan area ini sebagai container yang bisa di-scroll secara independen --}}
        <div class="flex-1 flex flex-col overflow-y-auto">
            
            <!-- Header untuk Tampilan Mobile (dibuat sticky) -->
