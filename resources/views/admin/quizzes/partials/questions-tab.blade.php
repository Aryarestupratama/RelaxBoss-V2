<div class="bg-white rounded-lg shadow-md">
    <div class="p-6 flex justify-between items-center">
        ...
        <button @click="showCreateModal = true" class="bg-blue-600 text-white font-semibold px-4 py-2 rounded-md hover:bg-blue-700">Tambah Pertanyaan</button>
    </div>
                ...
                @forelse ($quiz->questions as $question)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button @click="openEditModal({{ $question }})" class="text-indigo-600 hover:text-indigo-900">Edit</button>
                            <button @click="openDeleteModal({{ $question }})" class="text-red-600 hover:text-red-900 ml-4">Hapus</button>
                        </td>
                    </tr>
                @empty
                    <tr>
